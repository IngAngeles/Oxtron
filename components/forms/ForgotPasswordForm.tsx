                ...
                { success ?
                    <div className="h-fit my-20 flex flex-col gap-4">
                        <Lottie
                            ...
                            loop={true}
                        />
                        <p className="text-dark-600 text-center">An e-mail with further instructions <br /> has been successfully sent.</p>
                    ...
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 flex-1">
                            <section className="mb-7 space-y-4 text-center">
                                <h1 className="font-bold text-[24px] text-black title-century-gothic-bold">Forgot Password</h1>
                                <p className="text-[#9FA2B4] title-century-gothic-regular text-[14px]">Enter your email address to reset your password</p>
                            </section>
                            { error ?
                            ...
                            <Link href="/" className="text-black text-sm w-full font-extralight">
                                <p className="mt-4">Remembered your password? <b>Log In</b></p>
                            </Link>
                        </form>
                    </Form>
                }
