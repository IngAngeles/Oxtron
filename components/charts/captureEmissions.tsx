...
const CaptureEmissions: React.FC<CaptureEmissionsProps> = ({ captureEmissions }) => {
  return (
    <div className="h-screen rounded-[8px] shadow-custom p-6 max-h-[400px] md:w-[250px] w-full flex flex-col justify-between">
        ...
        <div>
            ...
            />
            <div className='-mt-4'>
                <p className='text-4xl font-bold text-neutral-800 font-sans text-center flex flex-col'> {captureEmissions}
            ...
            <p className='text-black text-sm text-left font-sans mt-4'>
                This is the improvement you can achieve. <br /> <br />
